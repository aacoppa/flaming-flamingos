all: bin/matrix.o bin/transformations.o bin/line.o bin/sphere.o bin/vector.o bin/box.o bin/screen.o bin/renderer.o bin/interface.o bin/physics.o bin/world.o 
